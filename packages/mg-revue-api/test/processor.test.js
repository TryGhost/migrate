...
describe('Process', function () {
    test('Can convert a single post', function () {
        ...
        expect(data.custom_excerpt).toEqual('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vestibulum orci ut lacus malesuada vestibulum. Integer quis pulvinar arcu. Ut eleifend porta convallis. Etiam eros arcu, dapibus eleifend lectus vitae, blandit lobortis magna.');
