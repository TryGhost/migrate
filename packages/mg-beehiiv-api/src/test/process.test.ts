...
describe('beehiiv API processor', () => {
    ...
    describe('processHTML', () => {
        ...
        it('converts subscribe button wrapper to Portal signup button', () => {
            ...
            const result = processHTML({post: {url: 'test', data: {html}} as any, options: {subscribeLink: '/#/portal/signup'}});
        ...
        it('rewrites comment links when comments enabled', () => {
            const html = '<div id="content-blocks"><p>Hello <a href="https://example.beehiiv.com/p/post-slug?comments=true" target="_blank" rel="noopener">Leave a comment</a></p></div>';
        ...
        it('leaves comment links from other domains untouched when comments enabled', () => {
            const html = '<div id="content-blocks"><p><a href="https://other.beehiiv.com/p/other?comments=true">Comment</a></p></div>';
            const result = processHTML({
                post: {url: 'https://example.beehiiv.com/p/post-slug', data: {html}} as any,
                options: {comments: true, commentLink: '#ghost-comments-root'}
            });
