...
describe('Clean HTML', function () {
    test('Can return nothing', function () {
        expect(cleanHTML()).toEqual('');
    });

    test('Removes left text alignment', function () {
    ...
    test('Removes center text alignment', function () {
    ...
    test('Removes right text alignment', function () {
    ...
    test('Changes inline font weight to bold tag', function () {
        ...
        expect(result).toEqual('<b>Hello</b> <span>Hello</span> <b>Hello</b> <span>Hello</span>');
    });

    test('Changes bold styles to inner b tag', function () {
        let html = '<a href="https://example.com" style="font-weight: bold;">Hello</a>';
        let result = cleanHTML({
            html,
            opinionated: true
        });
        expect(result).toEqual('<a href="https://example.com"><b>Hello</b></a>');
    });

    test('Changes inline font style to italic tag', function () {
        ...
        expect(result).toEqual('<i>Hello</i> <span>Hello</span> <i>Hello</i>');
    });

    test('Changes italic styles to inner b tag', function () {
        ...
        expect(result).toEqual('<a href="https://example.com"><i>Hello</i></a>');
    });

    test('Removes inline styles and bold & italic tags from headers', function () {
        ...
        expect(result).toEqual('<h2>Lorem ipsum dolor sit amet consectetur adipiscing <a href="https://example.com">elit</a> <a href="https://example.com">eiusmod</a></h2>');
    });

    test('Removes text color decelerations', function () {
        ...
        expect(result).toEqual('<a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a>');
    });

    test('Removes background color decelerations', function () {
    ...
    test('Removes empty <p> tags', function () {
        let html = ['<p></p>',
            '<p>Hello<br>World</p>',
            '<p><br></p>',
            '<p><br/></p>',
        ...
        expect(result).toEqual('<p>Hello<br>World</p><p>Again</p>');
    });

    test('Removes empty <li> tags', function () {
        let html = ['<li></li>',
        ...
        expect(result).toEqual('<li>Hello<br>World</li><li>Again</li>');
    });

    test('Wraps special lists in a HTML card', function () {
        let html = '<ol><li value="10">Lorem</li><li>Ipsum</li></ol>';
        let result = cleanHTML({
            html,
            cards: true
        });
        expect(result).toEqual('<!--kg-card-begin: html--><ol><li value="10">Lorem</li><li>Ipsum</li></ol><!--kg-card-end: html-->');
    });

    test('Does not double-wrap carded special lists', function () {
    ...
    test('Does not change Instagram embed', function () {
