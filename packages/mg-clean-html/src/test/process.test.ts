...
describe('Clean HTML', function () {
    ...
    it('Changes inline font weight to bold tag', function () {
        let html =
            '<span style="font-weight: bold;">Hello</span> <span style="font-weight: 100;">Hello</span> <span style="font-weight: 800;">Hello</span> <span style="font-weight: revert-layer;">Hello</span>';
        let result = cleanHTML({
            html,
            opinionated: true
        });
    ...
    it('Changes inline font style to italic tag', function () {
        let html =
            '<span style="font-style: italic;">Hello</span> <span style="font-style: normal;">Hello</span> <span style="font-style: oblique;">Hello</span>';
        let result = cleanHTML({
            html,
            opinionated: true
        });
    ...
    it('Removes inline styles and bold & italic tags from headers', function () {
        let html =
            '<h2>Lorem <b>ipsum</b> <strong>dolor</strong> <i>sit</i> <em>amet</em> <span>consectetur</span> <span style="font-weight: bold;">adipiscing</span> <a href="https://example.com">elit</a> <a href="https://example.com"><b>eiusmod</b></a>  </h2>';
        let result = cleanHTML({
            html,
            opinionated: true
        });
        assert.equal(
            result,
            '<h2>Lorem ipsum dolor sit amet consectetur adipiscing <a href="https://example.com">elit</a> <a href="https://example.com">eiusmod</a></h2>'
        );
    });

    it('Removes text color decelerations', function () {
        let html = [
            '<a href="https://example.com" style="color: red;">Hello</a>',
        ...
        assert.equal(
            result,
            '<a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a><a href="https://example.com">Hello</a>'
        );
    });

    it('Removes background color decelerations', function () {
        let html = [
            '<a href="https://example.com" style="background-color: red;">Hello</a>',
    ...
    it('Wraps special lists in a HTML card', function () {
        ...
        assert.equal(
            result,
            '<!--kg-card-begin: html--><ol><li value="10">Lorem</li><li>Ipsum</li></ol><!--kg-card-end: html-->'
        );
    });
    ...
    it('Does not wrap a special list after an unmatched HTML card begin marker', function () {
        let html = '<!--kg-card-begin: html--><ol><li value="10">Lorem</li><li>Ipsum</li></ol>';
        let result = cleanHTML({
            html,
            cards: true
        });
    ...
    it('Does not clean or normalize HTML inside HTML cards', function () {
        let html =
            '<!--kg-card-begin: html--><p style="text-align: left;" data-empty="">Hello <span style="font-weight: bold; color: red;">world</span></p><!--kg-card-end: html-->';
        let result = cleanHTML({
            html,
            opinionated: true,
            cards: true
    ...
    it('Cleans HTML outside HTML cards while preserving multiple cards', function () {
        let firstCard = '<!--kg-card-begin: html--><p style="text-align: left;">First</p><!--kg-card-end: html-->';
        let secondCard =
            '<!--kg-card-begin: html--><ol style="list-style: none;"><li value="2">Second</li></ol><!--kg-card-end: html-->';
        let html = `<p style="text-align: left;">Before</p>${firstCard}<p style="text-align: right;">Between</p>${secondCard}`;
        let result = cleanHTML({
            html,
            opinionated: true,
            cards: true
        });
        assert.equal(result, `<p>Before</p>${firstCard}<p>Between</p>${secondCard}`);
    });
