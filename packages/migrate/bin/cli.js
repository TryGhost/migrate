...
import bearCommands from '../commands/bear.js';
...
import mailchimpMembersCommands from '../commands/mailchimp-members.js';
import mediumCommands from '../commands/medium.js';
import mediumMembersCommands from '../commands/medium-members.js';
...
prettyCLI.command(bearCommands);
...
prettyCLI.command(mailchimpMembersCommands);
prettyCLI.command(mediumCommands);
prettyCLI.command(mediumMembersCommands);
