...
const MgImageScraper = require('../../mg-imagescraper');
const MgLinkFixer = require('@tryghost/mg-linkfixer');
const fsUtils = require('@tryghost/mg-fs-utils');
const makeTaskRunner = require('../lib/task-runner');
// const xmlIngest = require('@tryghost/mg-blogger-xml');
const xmlIngest = require('../../mg-blogger-xml');
    ...
    posts: {
        ...
        og_image: {
            ...
            convert: (x) => {
                ...
                let largeImgSrc = x.replace(imgSizeRegExp, '/s2000/');
                return largeImgSrc;
            }
        },
        og_title: {
