...
describe('Generates sane excerpts', function () {
    test('Handles long paragraphs', function () {
        ...
        expect(excerpt).toEqual(result);
    });

    test('handles multiple paragraphs', function () {
    ...
    test('handles one really long sentence', function () {
    ...
    test('handles formatting', function () {
    ...
    test('case that breaks', function () {
